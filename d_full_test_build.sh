...
check_status "Failed to run nix-collect-garbage"

echo "Copying hardware configuration..."
sudo cp $HARDWARE_CONF ./hosts/corvus/
...
sudo nixos-rebuild switch --flake .#corvus --option eval-cache false --show-trace --verbose
